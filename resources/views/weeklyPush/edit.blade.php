                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="time_to_send" name="time_to_send" class="form-control @error('time_to_send') is-invalid @enderror" value="{{ old('time_to_send', $weeklyPush->time_to_send) }}" type="time">
                        </div>
                    </div>
