...
<div class="block my-5">
    ...
    <div class="row row-cols-5" style="row-gap: 36px;">
        @for($i = 0; $i < 11; $i++) <div class="col">
            <img style="max-width: 200px;" src="{{ asset('assets/images/team-image.svg') }}" class="block-image" alt="Team image">
    </div>
    @endfor
</div>
...
<div class="map m-auto">
    <img src="{{ asset('assets/images/map-image.svg') }}" alt="Map Image" class="block-image" style="visibility: hidden;">
    <p class="display-5">Map</p>
</div>

</div>

<div class="block py-5" style="background-image: url('{{ asset('assets/images/start-now-back.svg') }}')">
