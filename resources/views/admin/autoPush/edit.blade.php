...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.autoPush.index', ['userId' => $user->id]) }}">Auto Pushes</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <form role="form" enctype="multipart/form-data" method="post" action="{{ route('admin.autoPush.update', ['userId' => $user->id, 'id' => $autoPush->id]) }}">
                <div class="row">
