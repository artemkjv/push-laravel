...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form role="form" enctype="multipart/form-data" method="post" action="{{ route('admin.customPush.update', ['userId' => $user->id, 'id' => $customPush->id]) }}">
                <div class="row">
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" @error('open_url') is-invalid @enderror value="{{ old('open_url', $customPush->open_url) }}" id="open_url" name="open_url">
                        </div>
