...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.template.index', ['userId' => $user->id]) }}">Templates</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <form role="form" enctype="multipart/form-data" method="post" action="{{ route('admin.template.store', ['userId' => $user->id]) }}">
                <div class="row">
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" @error('open_url') is-invalid @enderror value="{{ old('open_url') }}" id="open_url" name="open_url">
                        </div>
