...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.weeklyPush.index', ['userId' => $user->id]) }}" class="d-flex filters-wrapper mb-2">
                        <a href="{{ route('admin.weeklyPush.create', ['userId' => $user->id]) }}" class="btn btn-primary">Add Weekly Push</a>
                                ...
                                @foreach($weeklyPushes as $weeklyPush)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-around">
                                            <a href="{{ route('admin.weeklyPush.edit', ['userId' => $user->id, 'id' => $weeklyPush->id]) }}"
                                               class="btn btn-info btn-sm float-left mr-1">
                                                <ion-icon name="create" class="action-icon"></ion-icon>
                                            </a>

                                            <form
                                                action="{{ route('admin.weeklyPush.destroy', ['userId' => $user->id, 'id' => $weeklyPush->id]) }}"
