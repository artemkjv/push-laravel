...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.pushUser.index', ['userId' => $user->id]) }}" class="d-flex filters-wrapper mb-2">
                                ...
                                @foreach($pushUsers as $pushUser)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-around">
                                            <form
                                                action="{{ route('admin.pushUser.destroy', ['userId' => $user->id, 'id' => $pushUser->id]) }}"
