...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form role="form" enctype="multipart/form-data" method="post" action="{{ route('admin.tariff.store') }}">
                <div class="row">
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" name="is_default" type="checkbox" id="is-default">
