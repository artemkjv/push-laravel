            ...
            <div class="col-xl-4">
                ...
                <form method="post">
                    ...
                    <div class="form-control form-control-lg">
                        ...
                        <input id="email" name="email" type="email" class="input-lg input-rounded"
                    ...
                    <button type="submit" class="btn btn-lg btn-auth">Log in</button>
                </form>
            </div>
