...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('customPush.index') }}" class="d-flex filters-wrapper mb-2">
                        <a href="{{ route('customPush.create') }}" class="btn btn-primary">Add Custom Push</a>
                                ...
                                @foreach($customPushes as $customPush)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-around">
                                            <a href="{{ route('customPush.edit', ['id' => $customPush->id]) }}"
