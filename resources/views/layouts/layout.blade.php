...
<head>
    ...
    <script src="{{asset('assets/js/scripts.js?id=1')}}"></script>
    ...
    <link href="{{ asset('assets/css/layout.css?id=1') }}" rel="stylesheet">
    @livewireStyles
</head>
<body>
...
<script src="{{asset('assets/js/webpush.js?id=12')}}"></script>
<script>
