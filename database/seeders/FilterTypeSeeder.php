...
class FilterTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $filterTypes = [
            ['id' => '1','title' => 'First Session','description' => 'The first date/time the device communicated with our servers','table_name' => NULL,'field_name' => 'created_at','format' => 'DATE_SUB(CURRENT_DATE(), INTERVAL %d HOUR)','measurement' => 'hours ago','key_allowed' => '0'],
            ['id' => '2','title' => 'Last Session','description' => 'The most recent date/time the device communicated with our servers','table_name' => NULL,'field_name' => 'active_at','format' => 'DATE_SUB(CURRENT_DATE(), INTERVAL %d HOUR)','measurement' => 'hours ago','key_allowed' => '0'],
